...
if __name__ == '__main__':
    ...
    try:
        ...
        while(error):
            ...
            if error:
                print(
                    'ERROR: Chiave non trovata, assicurarsi di avere il file \'key.txt\' con la chiave inserita\n')
            else:
        ...
        myt = '{}-{}-{} {}:{}:{}'.format(now.year, now.month,
                                         now.day + days, myt.hour, myt.minute, myt.second)
        ...
        while(not error):
            ...
            myt = myt + timedelta(hours=pet.hour,
                                  minutes=pet.minute, seconds=pet.second)
            # start report
            error = report(bot)
            # if an error occours
            if error:
